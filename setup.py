...
janitoo_entry_points = {
    "janitoo.components": [
        "hostsensor.picpu = janitoo_hostsensor_raspberry.component:make_picpu",
    ],
}

setup(
    name = 'janitoo_hostsensor_raspberry',
    description = "A controller for local sensors : Raspberry components",
